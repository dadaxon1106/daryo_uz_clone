...
class _HomeScreenState extends State<HomeScreen> {
  List<NewsPost> posts = [
    ...
    NewsPost(
      title:"O‘zbekistonning ayrim hududlarida 1-iyul kuni yomg‘ir yog‘ishi mumkin",
      image:
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      return GestureDetector(onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context)=> DetailScreen(post: posts[index])));
